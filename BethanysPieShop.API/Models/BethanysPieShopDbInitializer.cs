...
{
    internal class BethanysPieShopDbInitializer
    {
        private readonly AppDbContext _context;
        private readonly ILogger<BethanysPieShopDbInitializer> _logger;

        public BethanysPieShopDbInitializer(AppDbContext context, ILogger<BethanysPieShopDbInitializer> logger)
        {
            _context = context;
            _logger = logger;
        }
        ...
        {
            _logger.LogInformation("Migrating database associated with AppDbContext");
